...
export async function findExpandDefinition(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken): Promise<vscode.DefinitionLink[] | undefined> {
...
export async function findIncludeDefinition(document: vscode.TextDocument, position: vscode.Position): Promise<vscode.DefinitionLink[] | undefined> {
    const lineText = document.lineAt(position.line).text;
    const includeRegex = /<Include\s+Script="([^"]+)"/gi;
    let match;
...
export async function findVariableDefinition(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken): Promise<vscode.DefinitionLink[] | undefined> {
